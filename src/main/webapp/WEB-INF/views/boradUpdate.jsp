              ...
              <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
                                         <h4 class="m-0 font-weight-bold text-primary">글 수정</h4>
                                        <ul class="navbar-nav ml-auto">
                    ...
                    <form name="form" id="form" role="form" method="post" action="/boradUpdate">
                        ...
                        <div class="card-header py-3">
                        	<label style="border:none; color: #4e73df!important;font-weight: bold;">작성자 : </label>
                              <input style="border:none; color: #4e73df!important;font-weight: bold;" name ="borad_name" value="${member.id}" readonly/>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            <input style="border:none; width: 1200px;" type="text" name="borad_title" id="title" value="${boradContent.borad_title}" class="m-0 font-weight-bold text-primary"></input>
                            <hr>
                            	<textarea class="m-0 font-weight-bold text-primary" name="borad_contents" id="contents" style="border:none; width: 1200px; height: 370px;">${boradContent.borad_contents}</textarea>
                               
                            </div>
                        </div>
                        <button style="position: relative; left: 530px" class="btn btn-sm btn-primary" type="submit" id="btnSave">저장</button>
						<button style="position: relative; left: 530px" type="button" class="btn btn-sm btn-primary" id="btnList" onclick="location.href='/borad?p=1&'">목록</button>
                        </form>
                    </div>
                </div>
            </div>

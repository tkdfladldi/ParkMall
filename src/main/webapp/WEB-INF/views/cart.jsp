        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h3 style="position: relative; left: 550px;" class="m-0 font-weight-bold text-primary">장바구니</h3><br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                	<thead>
                                        <tr role="row"><th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 5px;">상품 번호</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 20px;">상품 이미지</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 100px;">상품명</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 31px;">수량</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 33px;">가격</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 5px;">삭제</th></tr>
                                    </thead>
									        ...
									        <tr>
									            ...
									            <td>
									                <a href="${path}/nike_shoesChk/${cartItem.product_id}">
									                    <img src="../resources/assets/img/portfolio/${cartItem.product_url}" width="120px" height="110px">
									                </a>
									            </td>
									             <td>
									            ...
									            <td>
									            <button class="d-none d-sm-inline-block btn btn-sm btn-primary" onclick="location.href='/cartDelet/${Status.index}'">삭제</button>
									            </td>
									        </tr>
									    </c:forEach>
                                </table>
                ...
                <div class="col-xl-3 col-md-6 mb-4" style="position: relative; left: 500px;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                          	       제품 총 가격</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber value="${productPriceAdd}" pattern="###,###,###"/></div>
                                        </div>
                                        <div class="col-auto">

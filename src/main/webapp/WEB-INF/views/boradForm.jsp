              ...
              <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
                                         <h4 class="m-0 font-weight-bold text-primary">글 작성</h4>
                                        <ul class="navbar-nav ml-auto">
                    ...
                    <form name="form" id="form" role="form" method="post" action="boradForm">
                        ...
                        <div class="card-body">
                            ...
                            <input style="border:none; width: 1200px;" type="text" name="borad_title" id="title" class="m-0 font-weight-bold text-primary" placeholder="제목을 입력해주세요.."></input>
                            <hr>
                            	<textarea class="m-0 font-weight-bold text-primary" name="borad_contents" id="contents" style="border:none; width: 1200px; height: 370px;" placeholder="내용을 입력해주세요.."></textarea>
                               
                            </div>
                        </div>
                        <button style="position: relative; left: 530px" class="btn btn-sm btn-primary" id="btnSave">저장</button>
